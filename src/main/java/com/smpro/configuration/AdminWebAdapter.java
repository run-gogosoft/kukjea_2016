...
@ComponentScan(basePackages = {"com.smpro.controller.admin", "com.smpro.service", "com.smpro.dao", "com.smpro.component.admin", "com.smpro.component.admin.annotation"})
public class AdminWebAdapter extends WebMvcConfigurerAdapter {
	...
	@Bean
	public ViewResolver viewAdminResolver() {
