...
<%
    ...
    String sReturnUrl = "http://hknuri.sm-pro.co.kr/nice/checkplus/checkplus_success.jsp";      // 성공시 이동될 URL
    String sErrorUrl = "http://hknuri.sm-pro.co.kr/nice/checkplus/checkplus_fail.jsp";          // 실패시 이동될 URL
