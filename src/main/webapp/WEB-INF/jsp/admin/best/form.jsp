			...
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						...
						<!-- Style Code -->
						<div class="col-md-12" id="styleDiv">
							<div class="widget">
									...
									<form action="/admin/system/main/orderno/edit/proc" onsubmit="return submitProc(this);" method="post" target="zeroframe">
										...
										<table class="table table-bordered table-striped" style="margin-top:10px">
											...
											<tbody id="boardTarget">
												<tr><td colspan="7" class="text-center">등록된 상품이 없습니다.</td></tr>
											</tbody>
										</table>
									</form>
								</div>
				...
				<div id="searchStyleDiv" style="margin-top:30px;">
					<%-- 상품 검색 --%>
...
var regStyle = function(){
	$('#regStyleTitle').val("베스트 상품");//모달창의 제목을 form title태그에 넣는다.
	$('#regStyleForm').submit();
};
//배너 등록/수정시의 항목 검증
...
//상품추가
var goStyle = function (styleCode,limitCnt,orderNo) {
	var memberTypeCode = 'B';
	...
	$("#StyleTitle").html("<span style='display:inline-block;margin-top:10px;color:blue'>베스트 상품</span>");
	// if (styleCode != 4) {
	...
	$.ajax({
		...
		success: function (data) {
			...
			if($.parseJSON(data).listTitle === ''){
				...
				//최초 등록된 베스트상품 내용이 없다면 자동등록하도록한다.
				regStyle();
				return;
			} else {
				$('#listTitle').val('');
