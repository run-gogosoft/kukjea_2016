					...
					<li class="dropdown user user-menu">
						<a href="#"	class="dropdown-toggle" data-toggle="dropdown">
							<span class="hidden-xs">
								...
								<c:if test="${sessionScope.loginType eq 'S'}"> (입점업체)</c:if>
							</span>
						</a>
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				<li class="${navi eq 'index' ? 'active':''} treeview">
					<a href="/admin/index"><i class="fa fa-dashboard"></i> <span>Dashboard</span><i class="fa fa-angle-left pull-right"></i></a>
				</li>
				...
				<li class="${navi eq 'system' ? 'active':''} treeview">
					...
					<ul class="treeview-menu">
						...
						<li ${naviSub eq '/system/common/list' ? "class='active'":""}><a href="/admin/system/common/list"><i class="fa fa-caret-right"></i>공통코드 관리</a></li>
						...
						<li ${naviSub eq '/system/paymethod/fee/list' ? "class='active'":""}><a href="/admin/system/paymethod/fee/list"><i class="fa fa-caret-right"></i>결제수단별 수수료 관리</a></li>
						<li ${naviSub eq '/system/admin/list' ? "class='active'":""}><a href="/admin/system/admin/list"><i	class="fa fa-caret-right"></i>어드민 관리자</a></li>
						<li ${naviSub eq '/system/grade/manage/list' ? "class='active'":""}><a href="/admin/system/grade/manage/list"><i class="fa fa-caret-right"></i>관리자 등급 관리</a></li>
						...
						<li ${naviSub eq '/system/tmpl/list' ? "class='active'":""}><a href="/admin/system/tmpl/list"><i class="fa fa-caret-right"></i>템플릿 관리</a></li>
					</ul>
				</li>
				</c:if>
				...
				<li class="${navi eq 'member' ? 'active':''} treeview">
					...
					<ul class="treeview-menu">
						...
						<c:if test="${sessionScope.loginType eq 'A' and (sessionScope.gradeCode eq 0 or sessionScope.gradeCode eq 1 or sessionScope.gradeCode eq 2)}">
						<li ${naviSub eq '/member/excel/form' ? "class='active'":""}><a href="/admin/member/excel/form"><i class="fa fa-caret-right"></i>엑셀 포인트 등록</a></li>
						</c:if>
						<c:if test="${sessionScope.loginType eq 'A' and (sessionScope.gradeCode eq 0 or sessionScope.gradeCode eq 1 or sessionScope.gradeCode eq 2)}">
				...
				<li class="${navi eq 'seller' ? 'active':''} treeview">
					<a href="#"><i class="fa fa-building-o"></i> <span>업체 관리</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li ${naviSub eq '/seller/list/S' ? "class='active'":""}><a href="/admin/seller/list/S"><i class="fa fa-caret-right"></i>입점업체 리스트</a></li>
					</ul>
				</li>
				</c:if>
				<li class="${navi eq 'item' ? 'active':''} treeview">
					...
					<c:if test="${sessionScope.loginType eq 'A'}">
						...
						<li ${naviSub eq '/item/best/form' ? "class='active'":""}><a href="/admin/item/best/form"><i class="fa fa-caret-right"></i>베스트 상품 관리</a></li>
					</c:if>
					<c:if test="${sessionScope.loginType eq 'A' and (sessionScope.gradeCode eq 0)}">
						<li ${naviSub eq '/item/filter/list' ? "class='active'":""}><a href="/admin/item/filter/list"><i class="fa fa-caret-right"></i>금지어 관리</a></li>
					</c:if>
					</ul>
				</li>
				...
				<li class="${navi eq 'order' ? 'active':''} treeview">
					...
					<c:if test="${sessionScope.loginType eq 'A' and (sessionScope.gradeCode eq 0 or sessionScope.gradeCode eq 1 or sessionScope.gradeCode eq 2 or sessionScope.gradeCode eq 5)}">
						<li ${naviSub eq '/order/cs/log/list' ? "class='active'":""}><a href="/admin/order/cs/log/list"><i class="fa fa-caret-right"></i>CS 처리내역 리스트</a></li>
					</c:if>
					<c:if test="${sessionScope.loginType eq 'A' and (sessionScope.gradeCode eq 0 or sessionScope.gradeCode eq 1 or sessionScope.gradeCode eq 2 or sessionScope.gradeCode eq 5) or sessionScope.loginType eq 'S' or sessionScope.loginType eq 'D'}">
						<li ${naviSub eq '/order/delivery/upload' ? "class='active'":""}><a href="/admin/order/delivery/upload"><i class="fa fa-caret-right"></i>송장 일괄 업로드</a></li>
					</c:if>
					<c:if test="${sessionScope.loginType eq 'A' and (sessionScope.gradeCode eq 0 or sessionScope.gradeCode eq 1 or sessionScope.gradeCode eq 2)}">
				...
				<li class="${navi eq 'estimate' ? 'active':''} treeview">
					<a href="#"><i class="fa fa-file-text-o"></i> <span>견적 관리</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li ${naviSub eq '/estimate/list' ? "class='active'":""}><a href="/admin/estimate/list"><i class="fa fa-caret-right"></i>견적 신청 리스트</a></li>
						<li ${naviSub eq '/estimate/compare/list' ? "class='active'":""}><a href="/admin/estimate/compare/list"><i class="fa fa-caret-right"></i>비교견적 신청 리스트</a></li>
					</ul>
				</li>
				</c:if>
				<c:if test="${sessionScope.loginType eq 'A' or sessionScope.loginType eq 'S'}">
				<li class="${navi eq 'adjust' ? 'active':''} treeview">
					<a href="#"><i class="fa fa-calculator"></i> <span>정산 관리</span> <i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li ${naviSub eq '/adjust/list' ? "class='active'":""}><a href="/admin/adjust/list"><i class="fa fa-caret-right"></i> 입점업체 정산 리스트</a></li>
					</ul>
				</li>
				</c:if>
				<c:if test="${sessionScope.loginType eq 'A'}">
				<li class="${navi eq 'stats' ? 'active':''} treeview">
					...
					<ul class="treeview-menu">
						...
						<li ${naviSub eq '/stats/list/auth_category' ? "class='active'":""}><a href="/admin/stats/list/auth_category"><i class="fa fa-caret-right"></i> 인증기업별 매출 현황</a></li>
						<li ${naviSub eq '/stats/list/member' ? "class='active'":""}><a href="/admin/stats/list/member"><i class="fa fa-caret-right"></i> 회원별 매출 현황</a></li>
						<li ${naviSub eq '/stats/list/member/public' ? "class='active'":""}><a href="/admin/stats/list/member/public"><i class="fa fa-caret-right"></i> 공공기관별 매출 현황</a></li>
						...
						<li ${naviSub eq '/stats/list/item/jachigu/member' ? "class='active'":""}><a href="/admin/stats/list/item/jachigu/member"><i class="fa fa-caret-right"></i> 기간별 상품 판매 현황(공공기관)</a></li>
					</ul>
				</li>
				</c:if>
				...
				<li class="${navi eq 'board' or navi eq 'about' ? 'active':''} treeview">
					...
					<c:if test="${sessionScope.loginType eq 'A'}">
						...
						<li ${naviSub eq '/board/list/one' ? "class='active'":""}><a href="/admin/board/list/one"><i class="fa fa-caret-right"></i> 1:1 문의</a></li>
					</c:if>
						<li ${naviSub eq '/board/list/qna' ? "class='active'":""}><a href="/admin/board/list/qna"><i class="fa fa-caret-right"></i> 상품 문의(Q&amp;A)</a></li>
					<c:if test="${sessionScope.loginType eq 'A'}">
						<li ${naviSub eq '/board/review/list' ? "class='active'":""}><a href="/admin/board/review/list"><i class="fa fa-caret-right"></i> 상품평</a></li>
					</c:if>
					<c:if test="${sessionScope.loginType eq 'A'}">
