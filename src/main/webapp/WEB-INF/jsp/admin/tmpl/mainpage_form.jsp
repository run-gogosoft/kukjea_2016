...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>메인페이지 관리 <small></small></h1>
		<ol class="breadcrumb">
			<li><a href="/admin/index"><i class="fa fa-home"></i>Home</a></li>
			<li>시스템 관리</li>
			<li>템플릿 관리</li>
			<li class="active">메인페이지 관리</li>
		</ol>
	</section>
	<!-- 콘텐츠 -->
						...
						<div class="col-md-3">
							<div class="non-deco" style="width:250px">
								...
								<div class="clearfix t-margin">
									...
									<!-- main hero banner -->
									<div id="outer" class="round hand div-over t-padding" style="float:right;width:65%;" onclick="getDisplayVo('main','mainHeroBanner');">
										<div id="middle">
											<div id="inner">main hero  banner</div>
										</div>
									</div>
								</div>

								<!-- 사회적기업상품 -->
								<div class="round hand div-over clearfix t-margin t-padding styleBanner1" onclick="goStyle('1','4','0', this)">A itemList<br/>(사회적기업상품)</div>
								<!-- 협동조합상품 -->
								<div class="round hand div-over clearfix t-margin t-padding styleBanner2" onclick="goStyle('2','4','1', this)">A itemList<br/>(협동조합상품)</div>
								<!-- 장애인기업 상품 -->
								<div class="round hand div-over clearfix t-margin t-padding styleBanner3" onclick="goStyle('3','4','2', this)">A itemList<br/>(장애인기업상품)</div>
								<!-- 공정무역 상품 -->
								<div class="round hand div-over clearfix t-margin t-padding styleBanner9" onclick="goStyle('9','4','8', this)">A itemList<br/>(공정무역 상품)</div>
								<!-- 마을기업 상품 -->
								<div class="round hand div-over clearfix t-margin t-padding styleBanner10" onclick="goStyle('10','4','9', this)">A itemList<br/>(마을기업 상품)</div>
								<!-- A banner -->
								<div class="round hand div-over clearfix t-margin t-padding" onclick="getDisplayVo('main','mainBannerA');">A banner</div>
								<!-- B banner -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left" style="width:80px" onclick="getDisplayVo('main','mainBannerB');">B banner</div>
								<!-- B itemlist -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left styleBanner4" style="margin-left:5px;width:165px" onclick="goStyle('4','3','3', this)">B itemlist</div>
								<div class="clearfix"></div>
								<!-- C itemlist -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left styleBanner5" style="width:165px" onclick="goStyle('5','3','4', this)">C itemlist</div>
								<!-- C banner -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left" style="margin-left:5px;width:80px" onclick="getDisplayVo('main','mainBannerC');">C banner</div>
								<div class="clearfix"></div>
								<!-- D itemlist -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left styleBanner6" style="width:123px" onclick="goStyle('6','4','5', this)">D itemlist</div>
								<!-- E itemlist -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left styleBanner7" style="margin-left:4px;width:123px" onclick="goStyle('7','4','6', this)">E itemlist</div>
								<div class="clearfix"></div>
								<!--F배너는 나중에 통배너로도 쓸수 있기때문에 염두에 둔다.-->
								<!-- F banner -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left" style="width:123px" onclick="getDisplayVo('main','mainBannerF');">F banner</div>
								<!-- F itemlist -->
								<div class="round hand div-over clearfix t-margin t-padding pull-left styleBanner8" style="margin-left:4px;width:123px" onclick="goStyle('8','2','7', this)">F itemlist</div>
								<div class="clearfix"></div>
