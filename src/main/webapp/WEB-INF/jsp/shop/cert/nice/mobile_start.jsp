...
<%
    ...
    String sReturnUrl = request.getScheme()+"://"+request.getServerName()+"/shop/cert/nice/mobile/result/success";      // 성공시 이동될 URL
    String sErrorUrl = request.getScheme()+"://"+request.getServerName() +"/shop/cert/nice/mobile/result/fail";          // 실패시 이동될 URL
