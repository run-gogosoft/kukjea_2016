...
<%@ page language="java" import="Kisinfo.Check.IPINClient" %><%
	...
	*********************************************************************************************************************************************/
	...
	String sSiteCode				= "I704";			// IPIN 서비스 사이트 코드		(NICE평가정보에서 발급한 사이트코드)
	String sSitePw					= "qwqw1212";		// IPIN 서비스 사이트 패스워드	(NICE평가정보에서 발급한 사이트패스워드)
	...
	└────────────────────────────────────────────────────────────────────
	*/
	String sReturnURL				= request.getScheme()+"://"+request.getServerName() +"/shop/cert/nice/ipin/result";
