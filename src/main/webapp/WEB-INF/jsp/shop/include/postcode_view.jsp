		...
		<div class="hh-writebox-content">
			<div class="hh-writebox-text-check">
				...
				<div class="input-group" style="margin:10px auto;">
					<input type="text" class="form-control" id="keyword" style="width: 300px;height: 28px;font-size:12px;" onkeydown="CHPostCodeUtil.enterSearch();" placeholder="주소명" autofocus>
					<button type="button" class="btn btn-warning input-group-addon" onclick="CHPostCodeUtil.getAddr(1);" style="background-color:#f0ad4e;width: 62px;"><i class="fa fa-search"></i>검색</button>
				</div>
			</div>
	...
	<div class="hh-writebox-wrap">
		...
		<div class="hh-writebox-content">
			<div class="hh-writebox-text-check">
				...
				<p>◇ 검색결과는 최대 1000건까지만 보여집니다(자세한 주소를 입력해주세요).</p>
				<div class="input-group" style="margin:10px auto;">
					<input type="text" class="form-control" id="returnKeyword" style="width: 300px;height: 28px;font-size:12px;" onkeydown="CHReturnPostCodeUtil.returnEnterSearch();" placeholder="주소명" autofocus>
