		...
		<td style="width:300px;vertical-align:top;">
			<table class="table-bordered" style="width:100%">
				...
				<tbody>
					...
					<tr>
						<th>합계금액</th>
						<td><strong style="color:red"><fmt:formatNumber value="${totalAmount+totalDeliCost}"/>원 (부가세 포함)</strong></td>
					</tr>
				</tbody>
			</table>
		</td>
			...
			<table class="table-bordered" style="width:100%">
				...
				<c:forEach var="item" items="${list}" varStatus="status">
					<tr>
						...
						<td style="text-align:right"><fmt:formatNumber value="${item.orderCnt}"/>개</td>
						<td style="text-align:right"><fmt:formatNumber value="${(item.sellPrice + item.optionPrice) * item.orderCnt}"/>원</td>
					</tr>
				</c:forEach>
				<%-- <tr>
					...
					<td style="text-align:right"></td>
					<td style="text-align:right"><fmt:formatNumber value="${totalDeliCost}"/>원</td>
				</tr> --%>
				</tbody>
			</table>
		</td>
