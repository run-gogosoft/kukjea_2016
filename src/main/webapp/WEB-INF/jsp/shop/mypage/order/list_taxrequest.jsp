...
<div class="body-wrap">
	...
	<div class="main-content-wrap">
		<div class="breadcrumb">
			홈 <span class="breadcrumb-arrow">&gt;</span> 마이페이지 <span class="breadcrumb-arrow">&gt;</span> 구매정보 <span class="breadcrumb-arrow">&gt;</span> <strong>세금계산서</strong>
		</div>
		<div class="line"></div>
					...
					<c:forEach var="vo" items="${list}">
						<tr>
							<td data-merge-flag="${vo.orderSeq}">
								<a href="/shop/mypage/taxrequest/detail/${vo.orderSeq}"><strong>${vo.orderSeq}</strong></a><br/>
							...
							<td data-detail-merge-flag="${vo.orderSeq}">
								<a href="/shop/mypage/taxrequest/detail/${vo.orderSeq}"><i class="fa fa-building-o fa-3x" style="color:#e5be34;"></i></a>
							</td>
							<td>
