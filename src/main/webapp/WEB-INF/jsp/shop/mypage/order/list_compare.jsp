...
<div class="body-wrap">
	...
	<div class="main-content-wrap">
		<div class="breadcrumb">
			홈 <span class="breadcrumb-arrow">&gt;</span> 마이페이지 <span class="breadcrumb-arrow">&gt;</span> 구매정보 <span class="breadcrumb-arrow">&gt;</span> <strong>비교견적요청 관리</strong>
		</div>
		<div class="line"></div>
					...
					<c:forEach var="vo" items="${list}" varStatus="status">
						...
						<tr>
							<td data-merge-flag="${vo.orderSeq}" data-merge-flag-statuscode="${vo.statusCode}" style="letter-spacing:0;">
								<a href="/shop/mypage/compare/detail/${vo.orderSeq}"><strong>${vo.orderSeq}</strong></a><br/>
								(${fn:substringBefore(vo.regDate,' ')})
							</td>
							<td data-detail-merge-flag="${vo.orderSeq}" data-detail-merge-flag-statuscode="${vo.statusCode}">
								<a href="/shop/mypage/compare/detail/${vo.orderSeq}"><i class="fa fa-building-o fa-3x" style="color:#e5be34;"></i></a>
							</td>
							<td>
