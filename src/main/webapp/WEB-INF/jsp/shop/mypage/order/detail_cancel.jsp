...
<div class="body-wrap">
	...
	<div class="main-content-wrap" style="margin-bottom:70px">
		<div class="breadcrumb">
			홈 <span class="breadcrumb-arrow">&gt;</span> 마이페이지 <span class="breadcrumb-arrow">&gt;</span> 구매정보 <span class="breadcrumb-arrow">&gt;</span> <strong>취소/반품/교환 상세정보</strong> <span class="breadcrumb-arrow">&gt;</span> <strong>주문 상세정보</strong>
		</div>
		<div class="line"></div>
		...
		<div class="top-table">
			<div style="text-align:right;padding-bottom:5px;">
				<a href="/shop/mypage/cancel/list" class="btn btn-default">목록보기</a>
			</div>
			<table class="table">
				<colgroup>
					<col width="20%"/>
