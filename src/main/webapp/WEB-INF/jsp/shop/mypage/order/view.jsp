	...
	<tr>
		<td colspan="2" style="padding-top:20px;">
			<table class="table-bordered" style="width:100%">
				...
				<tfooter>
					<tr>
						<td colspan="5" style="text-align:right"><strong>합계금액(부가세포함)<strong></strong></td>
						<td style="text-align:right"><strong style="color:red"><fmt:formatNumber value="${totalAmount+totalDeliCost}"/>원</strong></td>
					</tr>
				</tfooter>
			</table>
		</td>
