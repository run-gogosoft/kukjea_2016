					...
					<div id="offer_price">
						<div class="tit_box">
							<dl class="offer_price">
								<dt>가격제안이란?</dt>
								<dd>국제몰닷컴의 회원님께 최저가 정책을 실현하기 위해 회원님과 소통을 통해 이뤄지는 상호운영서비스 입니다.<br />
									국제몰닷컴의 상품을 다른 몰에서 더 싸게 제공 할 경우 참고자료(해당 URL 또는 캡쳐 화면)를 보내주세요.<br />
									국제몰닷컴에서 확인 후 가격 조정 및 상응하는 조치를 하여 회원님께 보다 양질의 서비스를 제공하도록 노력하겠습니다.<br />
									아울러 자료를 제공해주신 회원님께는 감사의 의미로 국제몰닷컴에서 현금처럼 사용할 수 있는 포인트를 지급하여 드립니다.
								</dd>
							</dl>
						</div>
