            ...
            <div id="contents">
                ...
                <div class="sub_cont">
                    <div class="privacy_intro">
                        <dl>
                            <dt>국제메디팜 개인정보 처리방침</dt>
                            <dd>국제메디(이하 "회사"라 함)은 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 통신비밀보호법, 전기통신사업법등 정보통신서비스제공자가 준수하여야 할 관련 법규상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.</dd>
                        </dl>
                    ...
                    <div class="privacy_cont">
                        ...
                        <div class="cont">
                            <ol>
                                <li>가. 이용자 및 법정 대리인은 언제든지 국제메디몰의 “개인정보수정”을 통하여 회원님의 개인정보를 열람, 정정 처리하실 수있으며, 전자우편 또는 서면으로 요청하신 경우 열람, 정정, 삭제처리 해 드리겠습니다. 이용자의 개인정보가 제3자에게 제공되거나 취급위탁된 경우 이용자는 회사 또는 ‘제3자’, ‘수탁자’에게 파기를 요청할 수 있습니다. 단, 회원 아이디(ID)는 정정이 불가능합니다. 기타 법률에 따라 정정 또는 삭제가 금지되거나 제한되어 있는 경우에는 해당 처리가 제한될 수 있습니다. 또한 개인정보 오류에 대한 정정요청한 경우에는 다른 법률에 따라 개인정보의 제공을 요청받는 경우가 아닌 한 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다, 만약 잘못된 개인정보를 이미 제공한 경우에는 정정 처리 결과를 제 3자에게 통지 하여 정정이 이루어지도록 하겠습니다.</li>
                                <li>나. 이용자 및 법정 대리인은 언제든지 국제메몰의 개인정보에 대하여 처리의 정지를 요구 할 수 있습니다. 다만 아래의 경우에 해당하는 경우 처리정지 	요구를 거절할 수 있습니다.
                                    <ol>
                        ...
                        <div class="cont">
                            <p>본 홈페이지에 링크되어 있는 웹사이트들이 개인정보를 수집하는 행위에 대해서는 "국제몰닷컴 개인정보처리방침"이 적용되지 않음을 알려 드립니다.</p>
                        </div>
